# AutoTest: Enterprise QA Automation Engine 🚀

AutoTest is a highly resilient, full-stack AI orchestration engine that automatically translates raw Product Requirement Documents (PRDs) into structured QA Test Cases (Functional, Negative, and Edge). 
